...
div.innerHTML = `<button id=cancelBtn title=Esc>Cancel</button>
...
debug.style.cssText = 'width: 100%; height: 300px; font-family: monospace;';
cancelBtn.style.cssText = closeBtn.style.cssText = 'display: inline-block;';
