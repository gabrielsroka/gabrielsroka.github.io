...
https://github.com/gabrielsroka/gabrielsroka.github.io/blob/master/snippets/ImportTOTPSeedsFromCSV.js
...
(function () {
    ...
    function createPopup(title) {
        const popup = $(`<div style='position: absolute; z-index: 1000; top: 0px; max-height: calc(100% - 28px); max-width: calc(100% - 28px); padding: 8px; margin: 4px; overflow: auto; ` +
            ...
            `${title}<div style='display: block; float: right;'><a href='https://github.com/gabrielsroka/gabrielsroka.github.io/blob/master/snippets/ImportTOTPSeedsFromCSV.js' target='_blank' rel='noopener' style='padding: 4px'>?</a> ` + 
